      ...
      <div style={{ margin: '20px 0' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '5px', marginBottom: '15px' }}>
          <input 
            ...
            onChange={(e) => setTruckNumber({...truckNumber, state: e.target.value})}
            style={{ width: '50px', padding: '8px' }}
          />
          <input 
            type="text" 
            value={truckNumber.district}
            onChange={(e) => setTruckNumber({...truckNumber, district: e.target.value})}
            style={{ width: '50px', padding: '8px' }}
          />
          <input 
            type="text" 
            value={truckNumber.series}
            onChange={(e) => setTruckNumber({...truckNumber, series: e.target.value})}
            style={{ width: '30px', padding: '8px' }}
          />
          <input 
            type="text" 
            value={truckNumber.number}
            onChange={(e) => setTruckNumber({...truckNumber, number: e.target.value})}
